...
QueueDMATransfer:
		...
		move.l	#$94009300,d0 ; command to specify DMA transfer length & $00FF and length & $FF00
		move.b	d3,d0
		swap	d0
		lsr.w	#8,d3
		move.b	d3,d0
		move.l	d0,(a1)+ ; store command

		move.l	#$96009500,d0 ; command to specify source address & $0001FE and source address & $01FE00
		lsr.l	#1,d1
		move.b	d1,d0
		swap	d0
		lsr.l	#8,d1
