...
EMU_HARDWARE	equ	$00			; Hardware / BastEm / Retroarch (BlastEm core) / Ares / Genesis Plus GX
EMU_GPGX	equ	$01			; Old Genesis Plus GX / Retroarch / Bizhawk
EMU_REGEN	equ	$02			; Regen
EMU_KEGA	equ	$03			; Kega Fusion / M2 Emulator (Genesis Mini) 
EMU_GENS	equ	$04			; Gens
EMU_BLASTEM_OLD	equ	$05			; Old versions of BlastEm (stable release)
EMU_EXODUS	equ	$06			; Exodus
EMU_MEGASG	equ	$07			; Mega Sg
EMU_STEAM	equ	$08			; Steam
EMU_PICODRIVE	equ	$09			; Picodrive / Retroarch / Bizhawk
EMU_FLASHBACK	equ	$0A			; AtGames Flashback (ehh...)
EMU_FIRECORE	equ	$0B			; AtGames Firecore (Bad Sound)
